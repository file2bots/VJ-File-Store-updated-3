...
async def incoming_gen_link(bot, message):
    logger.info("New file received")  # Log when function is triggered
    ...
    try:
        ...
        # Process file name for title, year, quality, language
        ...
        logger.info(f"Extracted Metadata -> Title: {title}, Year: {year}, Quality: {quality}, Language: {language}")
        ...
        logger.info(f"File stored in DB_CHANNEL: {file_id}")

...
# Assuming you have a function that fetches movie poster from IMDb using OMDB API.
...
async def gen_link_batch(bot, message):
    ...
    # Here you can call IMDb API to get the movie poster
    #movie_title = "Example Movie Title"  # You can get this dynamically if you have the movie title
    elif current_state == "movie_title":
    ...
    # If a poster URL exists, include it in the message
    if poster_url:
        await sts.reply_photo(poster_url, caption=f"**Movie Poster for {movie_title}:**")
